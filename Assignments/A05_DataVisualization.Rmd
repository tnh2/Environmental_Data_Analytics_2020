...
NTL.PP.nut.tidy <- read.csv("./Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaul_Processed.csv")
NTL.PP.nut.gathered <- read.csv("./Data/Processed/NTL-LTER_Lake_Nutrients_PeterPaulGathered_Processed.csv")
NTL.PP.chemphys.tidy <- read.csv("./Data/Processed/NTL-LTER_Lake_ChemistryPhysics_PeterPaul_Processed.csv")
NIWO.Litter <- read.csv("./Data/Processed/NEON_NIWO_Litter_mass_trap_Processed.csv")

#2
class(NTL.PP.chemphys.tidy$sampledate)
NTL.PP.chemphys.tidy$sampledate <- 
  as.Date(NTL.PP.chemphys.tidy$sampledate, format = "%Y-%m-%d")
